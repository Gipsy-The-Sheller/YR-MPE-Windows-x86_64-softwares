...
typedef std::unordered_map<std::string, double> StringDoubleHashMap;
typedef std::unordered_map<std::string, int> PatternIntMap;
#else
typedef std::map<std::string, double> StringDoubleHashMap;
typedef std::map<std::string, int> PatternIntMap;
#endif
