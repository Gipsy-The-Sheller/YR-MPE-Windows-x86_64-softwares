...
#   endif
    ...
    MrBayesPrint("\n * Modified version for Windows x86_64 with");
    # ifdef (BEAGLE_ENABLED)
    MrBayesPrint(" BEAGLE");
    # endif
    # ifdef (MPI_ENABLED)
    MrBayesPrint(" MPI");
    # endif
    MrBayesPrint(" support.\n");
    MrBayesPrint(" * You can get a copy of modified source code by emailing zjxmolls@outlook.com\n");
    MrBayesPrint(" * Original MrBayes: https://github.com/NBISweden/MrBayes\n");
    // MrBayesPrint(" * Distributed under GNU General Public License v3\n");
    MrBayesPrint ("\nModified by: Zhi-Jie Xu (ORCiD: 0009-0003-3855-0921)\n");
}
